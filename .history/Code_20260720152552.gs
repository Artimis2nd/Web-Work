...
// ============================================================
// IMAGE UPLOAD — อัปโหลดรูป Base64 ไปยัง Google Drive
// สำหรับ addLogs: สร้างโฟลเดอร์ใหม่โดยใช้ timestamp (ไม่ต้อง scan)
// สำหรับ updateLogGroup: อ่าน folderName จาก Images sheet
// ============================================================
 ...
 * @param {Folder} folder - โฟลเดอร์ปลายทาง (ส่งมาให้แล้ว)
 * @return {string[]} Array ของ URLs
 */
...
/**
 * อัปโหลดรูปภาพเดี่ยว
 * ชื่อไฟล์: {groupIdShort}_{index}.jpg
 */
...
/**
 * สร้างโฟลเดอร์สำหรับใบงานใหม่ (addLogs)
 * ชื่อ: {date}_A{timestamp}_{groupId4}/
 * ใช้ timestamp ป้องกันชื่อซ้ำ ไม่ต้อง scan folders
 */
function createGroupFolder(dateStr, groupId) {
  ...
  var ts = String(Math.floor(new Date().getTime() / 1000)).slice(-5); // 5 หลักสุดท้ายของ timestamp
