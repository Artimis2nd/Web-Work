...
const Utils = (() => {
  ...
  /**
   * Converts a Date object or a date string to a 'YYYY-MM-DD' string suitable for APIs.
   * This is safer than toISOString() as it avoids timezone issues.
   * @param {Date | string | null} d The date to convert.
  ...
  return { money, formatDate, toInputDate, toApiDate, toast, skeletonRows, errorBanner, escapeHtml, renderShell, compressImage, animateProgress };
})();